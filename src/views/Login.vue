<template>
    <section class="min-h-screen">
        <section class="grid w-full h-screen grid-cols-2 grid-rows-1">
        <section class="relative flex items-end w-full h-full col-span-1 bg-gray-900">
            <img alt=""
        ...
        <section class="flex items-center justify-center w-full h-full col-span-1 bg-gray-100">
                ...
                <form class="mt-4 space-y-4">
                    <div>
                        ...
                        <input type="email" id="email" name="email"
                            class="block w-full px-3 py-2 mt-1 text-gray-800 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                    <div>
